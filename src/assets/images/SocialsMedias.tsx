...
function SocialsMedias({ className }: Props) {
    return (
        <div className={className + " socials-medias"}>
            <motion.a
                href="https://www.youtube.com/@juliencoindetaltore"
                target="_blank"
